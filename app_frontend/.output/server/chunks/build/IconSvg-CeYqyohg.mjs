import { a as useNuxtApp, i as useAppConfig, g as useState } from './server.mjs';
import { defineComponent, useSSRContext, h, watch, ref, computed, withAsyncContext, mergeProps, unref, createVNode, resolveDynamicComponent } from 'vue';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt-icon-tw@0.1.4_@nuxtjs+tailwindcss@6.12.1_magicast@0.3.4_rollup@4.20.0__magicast@0.3.4_ro_eo47rsr3ycbslhdw6hcrshdb2q/node_modules/nuxt-icon-tw/dist/runtime/IconSvg.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fa63bbae"]]);

export { __nuxt_component_1 as default };
//# sourceMappingURL=IconSvg-CeYqyohg.mjs.map
