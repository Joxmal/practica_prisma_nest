import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineComponent, provide, createElementBlock, defineAsyncComponent, h, computed, unref, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, cloneVNode, mergeProps, withCtx, createVNode, createApp, effectScope, reactive, getCurrentScope, isReactive, toRaw, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, onScopeDispose, shallowRef, isReadonly, toRefs, markRaw, isShallow } from 'vue';
...
import { h as createError$1, l as getRequestHeader, m as sanitizeStatusCode, n as setCookie, o as getCookie, p as deleteCookie, q as createHooks, t as toRouteMatcher, r as createRouter$1 } from '../runtime.mjs';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-BY5sVew1.mjs');
...
function createFetch(globalOptions = {}) {
  ...
  const $fetch = async function $fetch2(request, options2) {
...
const unhead_N8y8LSEvQS = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  ...
  },
  {
    name: "admin-dasboard",
    path: "/admin/dasboard",
    component: () => import('./index-DCNM1R81.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    name: "users",
    path: "/users",
    component: () => import('./index-D2pzG9u7.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  "jwt-auth": () => import('./jwt_auth-Bdt4k9h6.mjs')
};
...
const revive_payload_server_1oSNyCVfAQ = /* @__PURE__ */ defineNuxtPlugin({
  ...
  if (clone.render) {
    clone.render = (ctx, cache2, $props, $setup, $data, $options) => {
      ...
      if ($setup.mounted$ ?? ctx.mounted$) {
        const res = (_a2 = component.render) == null ? void 0 : _a2.bind(ctx)(ctx, cache2, $props, $setup, $data, $options);
        return res.children === null || typeof res.children === "string" ? cloneVNode(res) : h(res);
      } else {
        getFragmentHTML(ctx._.vnode.el ?? null) ?? ["<div></div>"];
    ...
    return Promise.resolve(((_a2 = component.setup) == null ? void 0 : _a2.call(component, props, ctx)) || {}).then((setupState) => {
      ...
      return (...args) => {
        if (mounted$.value) {
          ...
          getFragmentHTML((instance == null ? void 0 : instance.vnode.el) ?? null) ?? ["<div></div>"];
...
const clientOnly$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  clientOnlySymbol,
  createClientOnly,
  default: clientOnly
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-CIuK0Lje.mjs').then((r) => r["default"] || r.default || r));
const LazyIconSvg = defineAsyncComponent(() => import('./IconSvg-CeYqyohg.mjs').then((r) => r["default"] || r.default || r));
const LazyIconTw = defineAsyncComponent(() => import('./IconTw-CfM8SxUn.mjs').then((r) => r["default"] || r.default || r));
...
const plugin_EjKrvnBNH3 = /* @__PURE__ */ defineNuxtPlugin((_nuxtApp) => {
  const options2 = (/* @__PURE__ */ useRuntimeConfig()).public.tailwindIcons;
  const appConfig = useAppConfig();
  appConfig.nuxtIcon = defu(options2, appConfig.nuxtIcon);
  if (appConfig.nuxtIcon)
    appConfig.nuxtIcon.resolvedPrefixes = options2 == null ? void 0 : options2.resolvedPrefixes;
});
const options = {
  "images": true,
  "videos": true,
  ...
  "native": false,
  "directiveOnly": false,
  "defaultImage": "/images/tube-spinner.svg",
  "loadingClass": "isLoading",
  "loadedClass": "isLoaded",
  "appendClass": "lazyLoad",
  "observerConfig": {}
};
const plugin_KImbbk5FqO = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const isPictureChild = (el2) => el2.parentNode && el2.parentNode.tagName.toLowerCase() === "picture";
  const setAttribute = (el2, attribute) => {
    const dataAttribute = `data-${attribute}`;
    if (Array.isArray(el2)) for (const item of el2) setAttribute(item, attribute);
    else if (el2.getAttribute(dataAttribute)) {
      el2.setAttribute(attribute, el2.getAttribute(dataAttribute));
      el2.removeAttribute(dataAttribute);
      if (el2.parentNode.load) el2.parentNode.load();
    } else if (el2.tagName.toLowerCase() === "picture") {
      const img = el2.querySelector("img");
      if (img) {
        setAttribute(img, "src");
        setAttribute(img, "srcset");
        img.addEventListener("load", () => setClass(el2));
      }
    }
  };
  const setClass = (el2) => {
    el2.classList.remove(options.loadingClass);
    el2.classList.add(options.loadedClass);
  };
  const setEvents = (el2) => {
    ...
    el2.addEventListener(eventName, () => {
      if (isPictureChild(el2)) {
        if (el2.parentNode.getAttribute("data-not-lazy") === null) setClass(el2.parentNode);
        else el2.parentNode.removeAttribute("data-not-lazy");
      } else setClass(el2);
    });
  };
  nuxtApp.vueApp.directive("lazy-load", {
    beforeMount(el2) {
      setEvents(el2);
      if (!isPictureChild(el2) && options.appendClass) el2.classList.add(options.appendClass);
    },
    mounted(el2) {
      if (el2.tagName.toLowerCase() === "img") el2.src = options.defaultImage;
    },
    getSSRProps() {
      return {};
    }
  ...
  nuxtApp.vueApp.directive("not-lazy", {
    beforeMount(el2) {
      for (const item of [...el2.querySelectorAll("source"), ...el2.querySelectorAll("img")]) {
        setAttribute(item, "src");
        setAttribute(item, "srcset");
      }
      if (el2.tagName.toLowerCase() !== "picture") el2.removeAttribute("data-not-lazy");
    },
    getSSRProps() {
      return {};
    }
...
const plugin_rX4KJc0gH2 = /* @__PURE__ */ defineNuxtPlugin(() => {
  var _a2;
  const config = (/* @__PURE__ */ useRuntimeConfig()).public.nuxtJwtAuth;
  ...
  addRouteMiddleware("auth", async () => {
    var _a3;
    if (!((_a3 = cookie.value) == null ? void 0 : _a3.token)) {
  ...
  const login = async (credentials, callback) => {
    try {
      ...
      if ((response == null ? void 0 : response.token) && (response == null ? void 0 : response.user)) {
...
const plugins = [
  unhead_N8y8LSEvQS,
  plugin$1,
  revive_payload_server_1oSNyCVfAQ,
  plugin,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({
        key: unref(route).currentRoute.value.path
      }, _attrs), {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.12.4_@parcel+watcher@2.4.1_@types+node@22.3.0_ioredis@5.4.1_magicast@0.3.4_rollup@4.20_j5zxuzubp4n72fqbd2myjb3d5q/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.12.4_@parcel+watcher@2.4.1_@types+node@22.3.0_ioredis@5.4.1_magicast@0.3.4_rollup@4.20_j5zxuzubp4n72fqbd2myjb3d5q/node_modules/nuxt/dist/app/components/nuxt-root.vue");
